...
function findEmployeeById(employeeId) {
 ...
 function findEmployeeBySpecialization(specialization) {
    ...
    if (javascriptEmployee) {
        document.getElementById('employeeDetails').innerHTML =`<p>${javascriptEmployee.id}: ${javascriptEmployee.name}: ${javascriptEmployee.name} - ${javascriptEmployee.department} - $${javascriptEmployee.salary} - $${javascriptEmployee.specialization}</p>`;
    } else {
        document.getElementById('employeeDetails').innerHTML = 'no employee specializes in JavaScript ';
    }
 }