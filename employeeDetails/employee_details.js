...
function findEmployeeById(employeeId) {
 ...
 function findEmployeeBySpecialization(specialization) {
    const javascriptEmployee = employees.find(employee => employee.specialization === 'JavaScript');
    if (javascriptEmployee) {
        document.getElementById('employeesDetails').innerHTML =`<p>${javascriptEmployee.id}: ${javascriptEmployee.name}: ${javascriptEmployee.name} - ${javascriptEmployee.department} - $${javascriptEmployee.salary} - ${javascriptEmployee.specialization}</p>`;
    } else {
        document.getElementById('employeeDsetails').innerHTML = 'no employee specializes in JavaScript ';
    }
 }